...
import { Settings, Keyboard, Brain, Cloud, Download } from 'lucide-react'
...
type SettingsCategory = 'general' | 'editor' | 'ai' | 'backup' | 'import'

const categories = [
  { id: 'general' as const, label: 'General', icon: Settings },
  { id: 'editor' as const, label: 'Editor', icon: Keyboard },
  { id: 'ai' as const, label: 'AI & Search', icon: Brain },
  { id: 'backup' as const, label: 'Backup & Sync', icon: Cloud },
...
export function SettingsModal({ isOpen, onClose, theme, onThemeChange }: SettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white dark:bg-gray-900 rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[80vh] flex flex-col">
        {/* Header */}
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Sidebar */}
          <div className="w-40 shrink-0 border-r border-gray-200 dark:border-gray-700 p-2 space-y-1">
            {categories.map((cat) => {
              const Icon = cat.icon
              return (
                <button
